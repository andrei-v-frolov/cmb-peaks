...
BINS   := $(addprefix $(BINDIR)/,wiener fsynth lmask fcalc vhist xhist leakage-3j leakage-mc pxl2map digest ksmap remap)
...
almtools.o: almtools.fin maptools.fin magnetic.fin randomize.fin complex-qu.fin mapio.o
