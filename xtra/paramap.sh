...
awk '{print $1,$2,$4;}' LOCAL-PARAM | $BINDIR/pxl2map order-nest.fits peaks-gamma.fits
awk '{print $1,$2,$5;}' LOCAL-PARAM | $BINDIR/pxl2map order-nest.fits peaks-sigma.fits
awk '{print $1,$2,$6;}' LOCAL-PARAM | $BINDIR/pxl2map order-nest.fits peaks-alpha.fits
awk '{print $1,$2,$7;}' LOCAL-PARAM | $BINDIR/pxl2map order-nest.fits peaks-ksdev.fits
