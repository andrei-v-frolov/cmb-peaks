...
map2gif -xsz 800 -bar .true. -min 0.5137003373 -inp peaks-local.fits -out '!peaks-local-95.gif'
map2gif -xsz 800 -bar .true. -min 0.7170542898 -inp peaks-local.fits -out '!peaks-local-99.gif'
